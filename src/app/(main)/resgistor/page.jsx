            ...
            <div className="flex justify-center md:w-4/5 lg:w-4/12 mx-auto bg-white rounded ">
                <div className=" shadow-md px-10 w-full pb-8">
                    ...
                    <div>
                        ...
                        <p className="text-center my-2">Already have account? Please <Link className="text-[#6A67FF]" href="/login">Log in</Link></p>
                        ...
                        <div className="flex mt-3 justify-center items-center gap-5">
                            <Image src="/Group 1.png" width={30} height={30} alt="google"></Image>
                            <Image src="/Group 2.png" width={30} height={30} alt="google"></Image>
                        </div> 
